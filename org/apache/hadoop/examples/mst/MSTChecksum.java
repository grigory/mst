...
public class MSTChecksum extends Configured implements Tool {
...
public int run(String[] args) throws Exception {
    ...
    job.setJobName("MSTSum");
    job.setJarByClass(MSTChecksum.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new MSTChecksum(), args);
    System.exit(res);
  }
