 ...
 */
public class MSTOutputFormat extends FileOutputFormat<Text,Text> {
  ...
  static class MSTRecordWriter extends RecordWriter<Text,Text> {
    private boolean finalSync = false;
    private FSDataOutputStream out;

    public MSTRecordWriter(FSDataOutputStream out,
                            JobContext job) {
...
public RecordWriter<Text,Text> getRecordWriter(TaskAttemptContext job
    ...
    return new MSTRecordWriter(fileOut, job);
  }
