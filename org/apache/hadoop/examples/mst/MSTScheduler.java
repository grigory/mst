...
class MSTScheduler {
  ...
  private static final Log LOG = LogFactory.getLog(MSTScheduler.class);
  ...
  public MSTScheduler(String splitFilename, 
  ...
  public MSTScheduler(FileSplit[] realSplits,
  ...
  public static void main(String[] args) throws IOException {
    MSTScheduler problem = new MSTScheduler("block-loc.txt", "nodes");
